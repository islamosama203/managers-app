...
struct MerchantsSumView: View {
    ...
    var body: some View {
        ZStack {
            ...
            .onAppear {
                viewModel.getMerchantLoanSumByCategoryId()
                selectToday()
        }
        ...
        VStack {
            ...
            ScrollView(showsIndicators: false) {
                ForEach(viewModel.selectedReport, id: \.self) { report in
                    MerchantSumCellView(merchant: report)
...
#if DEBUG
struct MerchantsSumView_Previews: PreviewProvider {
    static var previews: some View {
        MerchantsSumView(viewModel: MerchantsSumView.ViewModel(container: .preview, categoryId: 1))
    }
}
#endif
